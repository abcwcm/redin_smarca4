...
# Expression profile in pseudotime coordinates for time points RPM1, RPM2, RPM3 and RPM4 with cells with no expression removed. {.tabset}
...
#to color cells log10(value + 0.1) as seen in the monocle package
...
Save Smarca4 values and NE_spearman values.
```{r}
